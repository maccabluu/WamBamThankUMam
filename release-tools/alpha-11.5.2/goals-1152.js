...
function installStyle(){
  if(document.getElementById('wam-1152-goals-style'))return;
  const s=document.createElement('style');
  s.id='wam-1152-goals-style';
  s.textContent=`
  ...
  .wam1140-boss .wam1140-goals strong{
